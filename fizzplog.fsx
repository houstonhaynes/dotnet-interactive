...
setTheme "dark" // dark, gray, default

// Save image to PNG
save ".\\img.png"

// Some styling changes
fig.chart.plotBackgroundColor.Set "#FFF"
fig.chart.plotBorderColor.Set "#432"
fig.chart.plotBorderWidth.Set 10
fig.title.style.fontFamily.Set "Fira Code"
fig.title.style.fontSize.Set "12px"
fig.title.style.color.Set "#FFF"
...
fig.xAxis.[0].labels.format.Set "{value.2} m"
